...
from routes import blog_cms as blog_cms_route
...
# Blog CMS (admin CRUD + AI writer + public feed)
blog_cms_route.set_database(db)
blog_cms_route.set_admin_verifier(lambda creds: verify_admin_token(creds))
api_router.include_router(blog_cms_route.router)
...
# Marketing campaigns (campaign planner storage)
