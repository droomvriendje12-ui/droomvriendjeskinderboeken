      ...
      <div className="max-w-[1100px] mx-auto px-6 py-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-5">
            ...
            <input value={uploadName} onChange={(e) => setUploadName(e.target.value)} placeholder="Naam (bijv. Zomer-actie 2026)" className="w-full bg-slate-800 border border-white/10 rounded-lg p-2.5 text-sm mb-2 focus:outline-none focus:border-emerald-400" data-testid="upload-name" />
